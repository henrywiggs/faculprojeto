...
?>
<div class="card-body">
    <h5 class="card-title fw-semibold mb-4">Remover Categoria</h5>
...
function remover(id,nome){
    var res = confirm('Deseja realmente excluir esta categoria: \n '+nome+' ?');
    if(res){
        removerAjax('categorias/controller', {id: id} , '#corpo');
    }
}
</script>