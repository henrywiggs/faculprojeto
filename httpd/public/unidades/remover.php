...
?>
<div class="card-body">
    <h5 class="card-title fw-semibold mb-4">Remover unidade</h5>
...
function remover(id,nome){
    var res = confirm('Deseja realmente excluir esta unidade: \n '+nome+' ?');
    if(res){
        removerAjax('unidades/controller', {id: id} , '#corpo');
    }
}
</script>