...
?>
<div class="card-body">
    <h5 class="card-title fw-semibold mb-4">Remover Cliente</h5>
...
function remover(id,nome){
    var res = confirm('Deseja realmente excluir este cliente: \n '+nome+' ?');
    if(res){
        removerAjax('clientes/controller', {id: id} , '#corpo');
    }
}
</script>