...
?>
<div class="card-body">
    <h5 class="card-title fw-semibold mb-4">Remover Fornecedor</h5>
    ...
    <p><i class="fa-solid fa-trash"></i> Remover</p>
...
function remover(id,nome){
    var res = confirm('Deseja realmente excluir este fornecedor: \n '+nome+' ?');
    if(res){
        removerAjax('fornecedores/controller', {id: id} , '#corpo');
    }
}
</script>