...
?>
<div class="card-body">
    <h5 class="card-title fw-semibold mb-4">Remover produto</h5>
...
function remover(id,nome){
    var res = confirm('Deseja realmente excluir esta produto: \n '+nome+' ?');
    if(res){
        removerAjax('produtos/controller', {id: id} , '#corpo');
    }
}
</script>